...
<script>
  ...
  new Chart(document.getElementById('chartExpectativaVida'), {
    type: 'line',
    data: {
      labels: ['1940', '1960', '1980', '2000', '2024'],
      datasets: [{
  ...
  // 4. Gráfico de Barras Comparativo: Investimento da Saúde no PIB
  new Chart(document.getElementById('chartSaudePIB'), {
    type: 'bar',
    data: {
      labels: ['Investimento Público', 'Investimento Privado', 'Total Investido (Brasil)'],
      datasets: [{
